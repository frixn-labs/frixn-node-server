function generateDailyReportEmail(orgName, adminName, reportDate, reportData) {
  const { leads, taps, deactivatedCards, topLinks = [] } = reportData;
  const subject = `📊 Daily Activity Report – ${orgName} – ${reportDate}`;
  ...
  const topLeadRows = leads.topEmployees.length > 0
    ...
    : `<tr><td colspan="2" style="padding:20px;text-align:center;font-size:14px;color:#94a3b8;">No leads captured yesterday.</td></tr>`;
  ...
  const topTapRows = taps.topEmployees.length > 0
    ...
    : `<tr><td colspan="2" style="padding:20px;text-align:center;font-size:14px;color:#94a3b8;">No taps recorded yesterday.</td></tr>`;
...
<head>
    ...
    <title>Frixn – Daily Report</title>
</head>
        ...
        <table width="620" cellpadding="0" cellspacing="0" style="max-width:620px;width:100%;">
          ...
          <tr>
            <td style="background:#0f0a04;border-radius:24px 24px 0 0;padding:40px;">
              <p style="margin:0 0 6px;font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:rgba(255,255,255,0.4);">${reportDate}</p>
              <h1 style="margin:0 0 8px;color:#f8fafc;font-size:26px;font-weight:900;">Daily Activity Report</h1>
              <p style="margin:0;color:rgba(255,255,255,0.5);font-size:15px;">${orgName}</p>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td style="background:#ffffff;border-radius:0 0 24px 24px;padding:40px;box-shadow:0 10px 40px rgba(0,0,0,0.05);">
              ...
              <p style="margin:0 0 36px;font-size:16px;color:#334155;line-height:1.7;">
                ...
                Here is a summary of your team's activity from <strong>yesterday</strong>. Keep the momentum going!
              </p>
                ...
                <tr>
                  <td style="padding:14px 20px;background:#0f0a04;border-radius:12px 12px 0 0;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td>
                          <p style="margin:0;font-size:16px;font-weight:800;color:#ffffff;">🎯 Leads Captured</p>
                        </td>
                        <td align="right">
                          <span style="background:#f97316;color:#fff;padding:4px 14px;border-radius:20px;font-size:14px;font-weight:800;">${leads.total} Total</span>
                        </td>
                      </tr>
                    </table>
                  </td>
                ...
                <tr>
                  <td style="padding:14px 20px;background:#0f0a04;border-radius:12px 12px 0 0;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td>
                          <p style="margin:0;font-size:16px;font-weight:800;color:#ffffff;">📡 NFC Taps</p>
                        </td>
                        <td align="right">
                          <span style="background:#f97316;color:#fff;padding:4px 14px;border-radius:20px;font-size:14px;font-weight:800;">${taps.total} Total</span>
                        </td>
                      </tr>
                    </table>
                  </td>
                ...
                <tr>
                  <td style="padding:14px 20px;background:#7f1d1d;border-radius:12px 12px 0 0;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td>
                          <p style="margin:0;font-size:16px;font-weight:800;color:#ffffff;">⚠️ Deactivated NFC Cards</p>
                        </td>
                        <td align="right">
                          <span style="background:#ef4444;color:#fff;padding:4px 14px;border-radius:20px;font-size:14px;font-weight:800;">${deactivatedCards.length} Card${deactivatedCards.length !== 1 ? 's' : ''}</span>
                        </td>
                      </tr>
                    </table>
                  </td>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="text-align:center;margin-bottom:28px;">
                <tr>
                  <td>
                    <a href="https://www.frixn.in/sites/frixn/admin/analytics" style="display:inline-block;padding:16px 44px;background:linear-gradient(135deg,#ea6c0a 0%,#1a0f06 100%);color:#ffffff;text-decoration:none;border-radius:10px;font-size:15px;font-weight:700;box-shadow:0 4px 20px rgba(249,115,22,0.3);">Go to Dashboard &rarr;</a>
                  </td>
                </tr>
              </table>
              ...
              <p style="margin:0;font-size:13px;color:#94a3b8;line-height:1.7;text-align:center;">
                This is an automated daily report from Frixn.<br>
          ...
          <tr>
            <td style="padding:32px 0;text-align:center;">
              <p style="margin:0;font-size:12px;color:#94a3b8;line-height:1.6;">
                Powered by <strong>Frixn</strong> · Daily Pulse for <strong>${orgName}</strong>
              </p>
            </td>
          </tr>
...
module.exports = { generateDailyReportEmail };
